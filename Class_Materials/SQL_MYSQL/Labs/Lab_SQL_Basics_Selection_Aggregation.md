...
Here, we will practice selecting and projecting data. You can answer all questions with only these clauses:
...
You can save your solutions into a sql file that you will submit via Github Url.
